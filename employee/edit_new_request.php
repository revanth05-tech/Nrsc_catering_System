...
// Hierarchy-based auto-assignment for officer
...
$defOfficerCode   = $officer['officer_code'] ?? $request['approving_officer_code'] ?? null;
$defOfficerName = !empty($officer['EMPLOYEENAME']) ? $officer['EMPLOYEENAME'] : ($request['approving_by'] ?? 'No reporting officer found');
$defOfficerDept = !empty($officer['DIVNFULLNAME']) ? $officer['DIVNFULLNAME'] : ($request['approving_department'] ?? 'N/A');
                                ...
                                <div class="grid-box">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="hidden" name="officer_code" value="<?= htmlspecialchars($defOfficerCode ?? '') ?>">
                                ...
                                <div class="grid-box">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <textarea name="special_instructions" class="form-control" rows="4"><?= htmlspecialchars($request['special_instructions'] ?? '') ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="grid-row-3">
                                ...
                                <div class="grid-box">
                                                ...
                                                <?php else: ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <button type="button" class="btn btn-sm btn-outline-danger px-2 py-1" onclick="removeRow(this, <?= $it['quantity'] * $it['unit_price'] ?>)">
                                    ...
                                    <div class="order-actions">
                                        <div class="total-box">
                                            Total: <span id="grand-total">₹<?= number_format($request['total_amount'] ?? 0, 2) ?></span>
                                        </div>
