<?php
// Admin Profile Section (FULLY FIXED)
...
$initials = strtoupper(substr($fullName ?: 'U', 0, 2));
?>
        ...
        <div class="card-body p-0">
            ...
            <div style="background: linear-gradient(135deg, var(--primary-50) 0%, var(--white) 100%);
                ...
                <h2 class="text-2xl font-bold mb-1" style="color: var(--gray-50);">
                    <?php echo htmlspecialchars($fullName ?: 'Administrator'); ?>
                </h2>
                ...
                <div style="display: grid;
                    ...
                    <div class="info-group">
                        ...
                        <div class="text-base font-medium">
                            <?php echo htmlspecialchars($userid ?: 'N/A'); ?>
                        </div>
                    </div>
                    ...
                    <div class="info-group">
                        ...
                        <div class="text-base font-medium">
                            <?php echo htmlspecialchars($department ?: 'Administration'); ?>
                        </div>
                    </div>
