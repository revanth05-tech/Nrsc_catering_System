        ...
        <div class="card-body p-0">
            ...
            <div class="p-6">
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 1.5rem; margin-bottom: 2rem;">
                    ...
                    <div class="info-group">
                        <label class="d-block text-xs uppercase font-bold text-muted mb-1" style="letter-spacing: 0.05em;">Role</label>
                        <div class="text-base font-medium" style="color: var(--gray-100);">
                            <?php echo htmlspecialchars(ucfirst($userData['role'] ?? 'User')); ?>
                        </div>
                    </div>
                </div>
